...
/*
Created on 2018-04-16 15:51:06
File ID: routefile
*/
/***************************************************************************
 ...
 ***************************************************************************/
$_mData = <<<'EOF'
s:16944:"<?xml version="1.0" encoding="utf-8"?>
<routes>
    ...
    <!-- User -->
      <route url="([a-zA-Z0-9_-]+)\.html" path="system/modules" module="user" controller="profile" action="index" vars="username" />
      ...
      <route url="dating/([a-zA-Z0-9_-]+)/?([^/]+)?" path="system/modules" module="user" controller="country" action="index" vars="country,city" />
      <!-- friend -->
      ...
      <!-- birthday -->
      <route url="user/birthday-people/?([a-z]{3,6})?" path="system/modules" module="user" controller="birthday" action="index" vars="gender" />
    ...
    <!-- Webcam -->
      <route url="picture-webcam" path="system/modules" module="webcam" controller="webcam" action="picture" />
    ...
    <!-- Game -->
      <route url="free-online-game" path="system/modules" module="game" controller="main" action="index" />
      <route url="game/([^/]+)/([0-9]+)" path="system/modules" module="game" controller="main" action="game" vars="title,id" />
      <route url="game/category/([^/]+)/?([a-zA-Z]+)?/?([a-zA-Z]+)?" path="system/modules" module="game" controller="main" action="category" vars="name,order,sort" />
      <route url="download/game/([0-9]+)" path="system/modules" module="game" controller="main" action="download" vars="id" />
      <!-- admin -->
      <route url="game/admin/edit/([^/]+)/([0-9]+)" path="system/modules" module="game" controller="admin" action="edit" vars="title,id" />

    <!-- Chat -->
      <route url="free-chat-room" path="system/modules" module="chat" controller="home" action="index" />

    <!-- Chatroulette -->
      <route url="free-chatroulette-speed-dating" path="system/modules" module="chatroulette" controller="home" action="index" />
